...
public class NinteenActivity  extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd=new ProgressDialog(NinteenActivity.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            new AsyncTask<Integer, Long, Boolean>() {
                ...
                protected void onPostExecute(Boolean result) {
                    pd.dismiss();
                    Intent intent=new Intent(NinteenActivity.this,EleventhActivity.class);
