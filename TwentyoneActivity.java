...
public class TwentyoneActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd=new ProgressDialog(TwentyoneActivity.this);
            ...
            public void onClick(View view) {
                new AsyncTask<Integer, Long, Boolean>() {
                    ...
                    protected void onPostExecute(Boolean result) {
                        pd.dismiss();
                        Intent intent=new Intent(TwentyoneActivity.this,EleventhActivity.class);
