...
public class SixteenActivity  extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd=new ProgressDialog(SixteenActivity.this);
            ...
            public void onClick(View view) {
                new  AsyncTask<Integer, Long, Boolean>() {
                    ...
                    protected void onPostExecute(Boolean result) {
                        pd.dismiss();
                        Intent intent=new Intent(SixteenActivity.this,EleventhActivity.class);
