...
public class SeventeenActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd=new ProgressDialog(SeventeenActivity.this);
            ...
            public void onClick(View view) {
                new  AsyncTask<Integer, Long, Boolean>() {
                    ...
                    protected void onPostExecute(Boolean result) {
                        pd.dismiss();
                        Intent intent=new Intent(SeventeenActivity.this,EleventhActivity.class);
