...
public class NinthActivity extends AppCompatActivity {
    ArrayList eeNames = new ArrayList<>(Arrays.asList("Item1","Item2","Item3","Item4","Item5","Item6"));
    ArrayList<Integer> aaImages=new ArrayList<Integer>(Arrays.asList(R.drawable.crockery1,R.drawable.crockery2,R.drawable.crockery3,R.drawable.crockery4,R.drawable.crockery5,R.drawable.crockery6));
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd=new ProgressDialog(NinthActivity.this);
    ...
    private void setNavigationDrawer(){
        ...
        CustomAdapter14 customAdapter14=new CustomAdapter14(NinthActivity.this, eeNames,aaImages);
        recyclerView.setAdapter(customAdapter14);}}
