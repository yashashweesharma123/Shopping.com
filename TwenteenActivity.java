...
public class TwenteenActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twenteen);
        pd=new ProgressDialog(TwenteenActivity.this);
            ...
            public void onClick(View view) {
                new AsyncTask<Integer, Long, Boolean>() {
                    ...
                    protected void onPostExecute(Boolean result) {
                        pd.dismiss();
                        Intent intent=new Intent(TwenteenActivity.this,EleventhActivity.class);
